...
\item If $n_1, n_2 \in N_\Sigma$ then they are formed using the deterministic constant rule (see Def.\ \ref{def:constant_traversal}).

\item If $n_1, n_2 \in L_\Sigma$  then they are formed using the deterministic value-constant rule (see Def.\ \ref{def:constant_traversal}).
