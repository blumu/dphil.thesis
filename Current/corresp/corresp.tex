...
\subsubsection{Sub-term projection (with respect to a reference node occurrence)}
\label{sec:tstar}
Let us fix a reference node-occurrence $n_0$ in a traversal $t$.
The \defname{sub-term projection} $t \filterplus n_0$ is defined to be the subsequence of $t$ consisting of the occurrences
...
\begin{proposition}[Sub-term projections are sub-traversals]
