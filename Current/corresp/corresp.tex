...
Moreover contrary to the compositional method, there is no need to implement the composition algorithm: the set of traversals is just obtained by following the traversal rules; hiding of internal nodes is postponed until the end.
...
\subsubsection{Verification} As mentioned before, the theory of traversals was first applied to the domain of verification of infinite structures by Ong. \todo{Application to the reachability problem.}
...
\subsubsection{Further correspondences}
