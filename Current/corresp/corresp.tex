...
\begin{definition}[Composition of revealed strategies]
...
\item for a $\langle \_ \ , \_ \rangle$-node, it is the pairing written $\langle \Sigma_1,
\Sigma_2 \rangle$;
...
where $int(\intersem{T})$ denotes the set of sequences of moves
in (some arena of) $\intersem{T}$ and $cover(u,U)$ denotes the
...
\begin{remark} The proof that follows is quite tedious but the idea is simple. Let us give the intuition.
