...
we proceed as in Mairson's encoding \cite{mairson1992spt} by introducing lambda-terms encoding set equality, set membership and subset tests, and we further parameterize these encoding by $n\in\nat$.
\begin{align*}
...
the safe lambda calculus is also NP-hard. Asperti \cite{asperti-np} gave an interpretation of SAT in the simply-typed lambda
