...
o\rightarrow o \}$.
By an easy reasoning (see the the term grammar construction of Zaionc \cite{DBLP:journals/tcs/Zaionc87}), we can derive the following equations inducing a grammar over the set of terminals $\Sigma \union \{\lambda x y \alpha z. , \lambda z. \}$ that generates precisely the terms of $\mathcal{N}^0_\emptyset$:
\begin{eqnarray*}
