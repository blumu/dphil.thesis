...
The PSPACE-hard lower bound for the equality problem is probably a
very coarse one. In fact even though we failed to encode quantifier
elimination in the safe lambda calculus, we still suspect the
problem to be non-elementary.
