...
Consequently $x$ points to the last node in $\pview{t \upharpoonright r} \filter N^{\lambda}$ with order strictly greater than $\ord{x}$. We have:
\begin{align*}
\pview{t \upharpoonright r} &= \pview{t} \upharpoonright r & (\mbox{by \cite[lemma 3.1.23]{blumtransfer}}) \\
