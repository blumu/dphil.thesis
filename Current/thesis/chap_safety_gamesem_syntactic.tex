...
\begin{definition}
We say that a term is \defname{almost-safe} if it is of the form
...
\rulenamet{app} and \rulenamet{abs} rules we can build the safe term $\Gamma \sentail \lambda \varphi_1 \ldots \varphi_n . N_0 N_1 \ldots N_k \varphi_1 \ldots \varphi_n :T$.
