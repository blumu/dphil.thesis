...
%        \subsection{Game-semantic analysis via a syntactic argument}
    \include{../lmcs-safelambda/safelambda}
    \include{../lmcs-safelambda/safe_complexity}
    \include{../lmcs-safelambda/safe_expressivity}
...
\chapter{Game-Semantic analysis of safety via syntactic arguments}
    \include{../lmcs-safelambda/safe_gamesem}
