...
\newif\ifdraftmode\draftmodefalse% draft-mode switch (working mode, for quick preview)
\newif\ifforexaminers\forexaminersfalse% for submission to examiners before the viva
\newif\ifonlineversion\onlineversionfalse% online version with coloured hyperlinks
\newif\ifbodleian\bodleianfalse% Bodleian library copy
