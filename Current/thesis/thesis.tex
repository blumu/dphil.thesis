...
Finally we study safety from the point of view of Algorithmic Game Semantics.
...
\todo{Make the bibliographical entries uniform: ``Firstname Lastname'' $\rightarrow$ ``F. lastname''}
