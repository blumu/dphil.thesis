...
%    Bodleian       Bodleian copy, for printing, single side, includes acknowledgement
%    Print          For my own printed bounded final copies, double side, includes acknowledgement
