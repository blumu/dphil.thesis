...
\ref{lem:red_pview_trav}, since $M$ is in $\beta$-normal form).
...
have:
\begin{align*}
\pview{t \filter r} &= \pview{t} \filter N^{r \vdash} & (\mbox{by Lemma \ref{lem:red_pview_trav}}) \\
...
are well-behaved), Lemma \ref{lem:red_pview_trav} holds in the
