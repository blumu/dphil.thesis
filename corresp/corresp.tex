...
\begin{eqnarray*}
\intersem{\Gamma \vdash \lambda \overline{\xi} . M } &=& \Lambda^n(\intersem{\Gamma, \overline{\xi} \vdash M })  \\
...
Let $\mathcal{C}$ denote the standard category of games $\sem{A}$
for some linear type $A$ and innocent strategies denoting
lambda-terms.
