...
\vspace{0.4cm}
Take the traversal $t = 
\rnode{q1}{\lambda f z}
\cdot \rnode{n2}{@} 
\cdot \rnode{n3}{\lambda g x}   \bkptr[ncurv=0.6]{60}{n3}{n2} 
...
\cdot \rnode{n9}{\lambda}       \bkptr[ncurv=0.4]{60}{n9}{n2}
...
\vspace{0.4cm}
$$\textcolor{blue}{
\textcolor{DarkGreen}{\varphi}(t \upharpoonright r)} =
\textcolor{blue}{
\textcolor{DarkGreen}{\varphi}\left(
\rnode{q1}{\lambda f z}     
\cdot \rnode{q3}{f}         \bkptr[linecolor=blue,ncurv=1]{50}{q3}{q1}
\cdot \rnode{q4}{\lambda}   \bkptr[linecolor=blue,ncurv=1]{50}{q4}{q3} 
\cdot \rnode{q2}{z}         \bkptr[linecolor=blue,ncurv=0.7]{80}{q2}{q1} 
\right)}
= \textcolor{red}{
\rnode{q1}{q}^1\
\rnode{q3}{q}^3\        \bkptr[linecolor=red,offset=-3pt]{60}{q3}{q1} 
\rnode{q4}{q}^4\        \bkptr[linecolor=red,offset=-3pt]{60}{q4}{q3}
\rnode{q2}{q}^2         \bkptr[linecolor=red,offset=-3pt,ncurv=0.5]{60}{q2}{q1} 
} \in \textcolor{red}{\sem{M}}.$$
%\note{
