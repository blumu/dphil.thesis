...
\begin{itemize}
\item The \textcolor{blue}{Safety} restriction is a constraint on the order of the variables occurring in a grammar.
\item The \textcolor{blue}{Safe $\lambda$-calculus}, a sub-language of the simply typed $\lambda$-calculus.
\end{itemize}
}
...
\item Algorithmic behaviour of safety
\item Game semantics
...
\begin{itemize}
\item It is a \highlight{syntactical constraint}.
\item First appeared under the name "restriction of derived types" in "IO and OI Hierarchies" by W. Damm TCS 1982
\item Knapik, Niwi\'nski and Urzyczyn (2001,2002) proved decidability of Monadic Second Order logic on recursion scheme satisfying
the safety syntactical constraint.
\item 

* definition for order2
* examples
\end{itemize}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Safety as a way to define recursionRestriction?}
\frame{\frametitle{What is the Safety Restriction?}
