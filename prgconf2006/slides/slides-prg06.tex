...
Take the traversal $t = \rnode{q1}{\lambda f z w} \cdot
\rnode{n2}{@^{[2]}} \cdot \rnode{n3}{\lambda g x^{[3]}} \cdot
...
Its reduction is $r = \rnode{q1}{\lambda f z} \cdot
\rnode{q3}{f}^{[6]} \cdot \rnode{q4}{\lambda^{[7]}} \cdot
\rnode{q2}{z} \bkptr[ncurv=1]{60}{q3}{q1}
\bkptr[ncurv=1]{50}{q4}{q3} \bkptr[ncurv=0.4]{80}{q2}{q1}$

\vspace{0.2cm} We have $\varphi(r) = \rnode{q1}{q}^1\
