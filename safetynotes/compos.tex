...
Similarly $\pomove$ and $\pmove_A$ are the \defname{generalized P-moves in component $A,B$},
$\omove_C$ and $\pomove$ are
the \defname{generalized O-moves in component $B,C$}
and  $\pmove_C$ and $\opmove$ are the \defname{generalized P-move in component $B,C$}.
