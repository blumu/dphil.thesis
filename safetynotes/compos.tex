...
Take $A=o$, $B=(o,o)$, $C=o$. Let $x,u,v:o$, $y:(o,o)$ be variables and $\varphi:((o,o),o)$ and $a:o$ be $\Sigma$-constants.
...
Theorem \ref{thm:safeincrejust}(ii) (or Theorem \label{thm:safeincrejust_pcf}(ii) in the case of \pcf) to conclude that
...
The previous example can be easily changed into a working counter-example: we just need to elevate $\varphi$ from constant to variable status. 
