...
\item The unsafe term $\lambda y^o z^o. (\lambda x^o .y) z$ can be contracted without renaming variables. Hence safety does not capture ``variable-renaming uselessness''.
 \end{enumerate}
}
...
\highlight{Question:} Is the game model of Safe PCF fully-abstract (with respect to safe context)?
 }
