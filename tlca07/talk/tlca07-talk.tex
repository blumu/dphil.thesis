...
\item The unsafe term $\lambda y^o z^o. (\lambda x^o .y) z$ can be contracted using without renaming variables. Hence safety does not capture ``variable-renaming uselessness''.
 \end{enumerate}
}
...
\section{Safe numerical functions}
\frame{ \frametitle{Numerical functions: examples}
Let $n,m \in \nat$.
\begin{itemize}
