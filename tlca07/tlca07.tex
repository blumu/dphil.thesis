...
Consider the justified sequence of moves $s =
...
$\vspace*{1cm} r = \rnode{q1}{\lambda f z} \cdot
\rnode{q3}{f}^{[6]} \cdot
...
This examples shows how we can map nodes of the computation tree to question moves of the game arena.
