...
\begin{example}
  ...
  justified.
\end{example}
Note that P-incremental justification does not imply
innocence. Indeed, although the pointer is determined by the P-view,
the choice of the move itself can depend on the whole history of the
play.
