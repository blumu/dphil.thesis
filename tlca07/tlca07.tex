...
%   that
% \begin{enumerate}[(i)]
% \item $t$ occurs in an {\em operand} (i.e.~second) position of some
%   occurrence of the implicit application operator i.e.~$e$ has the
...
$
% the next line must be commented if the paragraph appears at the top of the page (otherwise
...
follows \raisebox{0cm}[0.4cm]{$\rnode{m}{m} \ldots \rnode{n}{n}
  \link*{45}{n}{m} \lnklabel*{i}$}.  where the label
...
& \pview{s \cdot \rnode{m}{m} \cdot \ldots \cdot \rnode{lmd}{\lambda \overline{\xi}}} &=& \pview{s} \cdot \rnode{m2}{m} \cdot \rnode{lmd2}{\lambda \overline{\xi}}   \link*{40}{lmd}{m}
\link*{70}{lmd2}{m2}\\
...
\raisebox{0cm}[0.4cm]{$\rnode{n}{n} \ldots \rnode{vn}{v_n}
  \link*{30}{vn}{n} \lnklabel*{v}$}.  For the definition
...
\item[{\bf (App)}] If $t \cdot @$ is a traversal then so is $t \cdot \rnode{m}{@} \cdot \rnode{n}{n}\link*{20}{n}{m} \lnklabel{0}$.
...
\raisebox{0cm}[0.4cm]{$t_1 \cdot \rnode{x}{x} \cdot t_2 \cdot \rnode{xv}{v_x} \link*{30}{xv}{x} \lnklabel*{v}$}
...
\item[{\bf (InputVar)}] If $t_1 \cdot x \cdot t_2$ is a traversal with
  ...
  t_2)=?(t_1) \cdot x$ then so is \raisebox{0cm}[0.4cm]{$t_1 \cdot
    ...
    \link*{30}{n}{m} \lnklabel*{i}$} for all
...
\item[{\bf (Copycat$^@$)}]
  If $t \cdot \rnode{app}{@} \cdot \rnode{lz}{\lambda \overline{z}}  \ldots  \rnode{lzv}{v}_{\lambda \overline{z}}
              \link*{55}{lzv}{lz} \lnklabel*{v}
              \link*{45}{lz}{app} \lnklabel{0}$
              is a traversal then so is
              \raisebox{0cm}[0.6cm]{$t \cdot \rnode{app}{@} \cdot \rnode{lz}{\lambda \overline{z}}  \ldots  \rnode{lzv}{v}_{\lambda \overline{z}} \cdot \rnode{appv}{v}_@
              \link*{35}{lzv}{lz} \lnklabel*{v}
              \link*{55}{lz}{app} \lnklabel{0}
              \link*{35}{appv}{app} \lnklabel*{v}$}.

\item[{\bf (Copycat$^\lambda$)}] If \raisebox{0cm}[0.4cm]{$t \cdot \lambda \overline{\xi} \cdot \rnode{x}{x}  \ldots   \rnode{xv}{v}_x
              \link*{45}{xv}{x} \lnklabel*{v}$}
              is a traversal then so is
              \raisebox{0cm}[0.5cm]{$t \cdot \rnode{lmd}{\lambda \overline{\xi}} \cdot \rnode{x}{x}  \ldots  \rnode{xv}{v}_x \cdot
              \rnode{lmdv}{v}_{\lambda \overline{\xi}}
              \link*{45}{xv}{x} \lnklabel*{v}
                \link*{35}{lmdv}{lmd} \lnklabel*{v}$}.

\item[{\bf (Copycat$^{var}$)}] \raisebox{0cm}[0.4cm]{If $t \cdot y \cdot \rnode{lmd}{\lambda \overline{\xi}}
                   \ldots \rnode{lmdv}{v}_{\lambda \overline{\xi}} \link*{35}{lmdv}{lmd} \lnklabel*{v}$}
        ...
        \raisebox{0cm}[0.6cm]{$t \cdot \rnode{y}{y}
            \cdot \rnode{lmd}{\lambda \overline{\xi}}
             ...
             \rnode{lmdv}{v}_{\lambda \overline{\xi}}
            \cdot \rnode{yv}{v}_y
                \link*{45}{yv}{y} \lnklabel*{v}
                \link*{40}{lmdv}{lmd} \lnklabel*{v}$}.
\item[{\bf (Var)}]
If  \raisebox{0cm}[0.5cm]{$t' \cdot \rnode{n}{n} \cdot
    \rnode{lx}{\lambda \overline{x}}  \ldots
    \rnode{x}{x_i}  \link*{50}{x}{lx} \lnklabel*{i}$} is a traversal for some variable $x_i$ not in $N_{var}^{\upharpoonright r}$ then
    so is
\raisebox{0cm}[0.6cm]{
    ...
    \link*{40}{letai}{n} \lnklabel*{i}
    \link*{30}{x}{lx} \lnklabel*{i}$}.
\end{description}
\end{definition}
...
\link*{30}{x}{lx}  \lnklabel*{i}
\link*{40}{leta}{y}  \lnklabel*{i}
\link*{35}{y}{ly}  \lnklabel*{1}
\link*{40}{lx}{app}  \lnklabel*{1}$} is an example of traversal of the computation tree shown on the right.
...
\travset \link*{25}{m}{n}$'' for some expression $P$
