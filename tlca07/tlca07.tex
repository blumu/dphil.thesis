...
\Pstr[0.6cm]{t \cdot (app){@} \cdot (lz-app,55){\lambda \overline{z}} \lnklabel{0} \ldots  (lzv-lz,35){v}_{\lambda \overline{z}} \lnklabel*{v} \cdot (appv-app,35){v}_@ \lnklabel*{v}}.
...
\ldots (lmdv-lmd,35){v}_{\lambda \overline{\xi}} \lnklabel*{v}} is a traversal for some variable $y$ not in $N_{var}^{\upharpoonright r}$ then so is
\Pstr[0.6cm]{t \cdot 
(y){y} \cdot
(lmd){\lambda \overline{\xi}} \ldots
(lmdv-lmd,35){v}_{\lambda \overline{\xi}} \lnklabel*{v} \cdot
