...
%
\titlerunning{Safe $\lambda$-calculus}  % abbreviated title (for running head)
...
\tocauthor{William Blum (University of Oxford), C.-H. Luke Ong
(University of Oxford)}
%

\institute{Oxford University Computing Laboratory\\ Wolfson
Building,
Parks Road, Oxford, OX1 3QD, ENGLAND\\
\email{william.blum@comlab.ox.ac.uk\inst{1}
luke.ong@comlab.ox.ac.uk\inst{2}} }
