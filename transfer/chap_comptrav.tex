...
the set of reduction of the traversals over its computation tree;
...
\item the tree for $\alpha s_1 \ldots s_m$ where $m\geq0$ and $\alpha$ is a variable or constant is:
...
\item the tree for $(\lambda x.s_0) s_1 \ldots s_n$ where $n \geq 1$ is:
