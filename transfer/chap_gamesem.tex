...
passes the test $\alpha$ if $\sigma ; \alpha = \top$.
...
$$ \sigma \lesssim \tau \quad \iff \quad \forall \alpha : A \rightarrow \Sigma. \sigma ; \tau = \top \imp \tau ; \alpha = \top$$
...
$$
\begin{array}{ccccc}
!\mathtt{com} & \times & ! \mathtt{exp} & \multimap & \mathtt{exp}\\
&&&&q\\
\iarun\\
\iadone\\
&&q\\
...
Assignment and dereferencing are denoted  by the following strategies (left and right respectively):
$$
\begin{array}{ccccc}
!\mathtt{var} & \times & ! \mathtt{exp} & \multimap & \mathtt{com}\\
&&&&q\\
&&q\\
&&n\\
\iawrite_n\\
