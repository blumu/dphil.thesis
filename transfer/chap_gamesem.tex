...
well the notion of game that we are exposing here. There are dialog games in which one person (O) interviews another person (P),
P trying to answer the initial O-question by possibly asking O some precisions about its initial question.}.
...
is induced by the edges of the forest arena. An answer is always justified by the question that it answers, a question
...
\begin{dfn}[Legal justified sequence]
dfg
\end{dfn}
