...
\subsubsection{Finitary Idealized algol}
Finitary Idealized algol is the recursion-free sub-fragment of \ialgol over finite ground types.
A term $\Gamma \vdash M:T$ of finitary Idealized algol is an $i^{th}$-order term if
$T$ is of order $i$ at most and the variables in
$\Gamma$ are of order strictly less than $i$.
$\ialgol_i$ denotes the fragment of finitary Idealized Algol consisting of terms of $i^{th}$-order terms.
...
The set of complete plays in the game semantics of a $\ialgol_2$-terms is regular.
\end{lem}


\begin{thm}[(Ghica + McCusker 2000)]
For $\ialgol_2$-terms M and N,  $M ¼ N$ () [ ¡ ` M : A]reg | {Rz
} ´ [ ¡ ` N : A]reg | {Sz }
...
$\ialgol_2$ Yes. (Ghica+McCusker ICALP’00)

$\ialgol_2$ + while Yes (Ghica+McCusker ICALP’00)
$\ialgol_2$+ Y1 No. (Ong LICS’02)


$\ialgol_3$ Yes: Reduction to DPDA Equivalence. (Ong LICS’02)
...
What about $\ialgol_i$ + Y0, for i = 1; 2; 3? Complexity?
...
$\ialgol_0$ & PTIME &– &– &– \\
$\ialgol_1$ & CO-NP & PSPACE & DPDA EQUIV & undecidable \\
...
Two orthogonal directions of extension: Fragments of IA Is
observational equivalence decidable? IA2 Yes. (Ghica+McCusker
ICALP’00) IA2 + while Yes (Ghica+McCusker ICALP’00) IA2 + Y1 No.
(Ong LICS’02) IA3 Yes: Reduction to DPDA Equivalence. (Ong LICS’02)
IAi; i ¸ 4 No. (Murawski LICS’03) IA3 + while Yes. (Murawski +
Walukiewicz FOSSACS’05) (Ong MFPS’04) What about IAi + Y0, for i =
1; 2; 3? Complexity?
