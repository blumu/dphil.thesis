...
\pview{ s \cdot \rnode{m}{m} \cdot t \cdot \rnode{n}{n} \bkptra{60}{n}{m} } &=
 \pview{s} \cdot \rnode{mm}{m} \cdot \rnode{nn}{n} \bkptra{80}{nn}{mm} && \mbox{ if $n$ is a non initial O-move }
\end{align*}
...
\oview{ s \cdot \rnode{m}{m} \cdot t \cdot \rnode{n}{n} \bkptra{60}{n}{m} } &=
 \pview{s} \cdot \rnode{mm}{m} \cdot \rnode{nn}{n} \bkptra{80}{nn}{mm} && \mbox{ if $n$ is a P-move }
\end{align*}
\end{dfn}
