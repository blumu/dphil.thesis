...
%\includeonly{chap_previouswork,chap_gamesem,safe_gamesem2}
...
semantics of safe terms by what we call ``safe justification''. In
safely-justified strategies, pointers are superfluous (i.e. they can
be recovered uniquely from the sequence of moves). This
...
giving some hints for a possible extension of the result to Safe
Idealized Algol.
...
\chapter{Safe $\lambda$-calculus}
    ...
    \include{safe_background}
    \include{safe_homog}
    \include{safe_nonhomog}
