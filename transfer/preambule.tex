...
%% \CompileMatrices causes problem with the \justseq macro
%%%\CompileMatrices
...
% traversals
\newcommand\travset{\mathcal{TRAV}}

% interaction game semantics
\newcommand\intercomp{\fatsemi{^\|}}


% ia
\newcommand\ialgol{\textsl{IA}}
\newcommand\iaseqcom{$\mathtt{seq_{com}}$}
\newcommand\iaseqexp{$\mathtt{seq_{exp}}$}
