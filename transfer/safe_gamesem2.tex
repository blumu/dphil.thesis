...
\begin{eqnarray*}
s q \in \sigma \wedge |s| \mbox{ even } &\implies& \parbox{10cm}{$q$ points to the last P-move in $\oview{?(s)}$ with order greater or equal to $\ord{q}$} \\
s q \in \sigma \wedge |s| \mbox{ odd } &\implies& \parbox{10cm}{$q$  points to the last O-move in $\pview{?(s)}$ with order greater or equal to $\ord{q}$}
\end{eqnarray*}
\end{dfn}
