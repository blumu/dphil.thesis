...
Justified sequence of nodes can be ordered using the prefix ordering: $t \sqsubseteq t'$ if and only if the sequence of nodes
$t$ is a prefix of $t'$ and the pointers of $t$ are the same as the pointers of the corresponding prefix of $t'$.
