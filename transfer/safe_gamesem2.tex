...
%We use the notation $[n_1,n_2]$ to denote the path from node $n_1$ to node $n_2$ if it exists and $]n_1,n_2]$ for
...
\begin{lem}[Safe terms have regular computation trees]
